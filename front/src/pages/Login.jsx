    ...
    <div className="min-h-screen bg-[#fafaf9] flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="bg-white rounded-3xl shadow-[0_2px_40px_rgba(0,0,0,0.08)] p-8">
          ...
          <p className="text-gray-500 text-sm mb-8">Sign in to your EventX account</p>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/signup" className="font-semibold text-orange-500 hover:text-orange-600 transition-colors">
              Sign up free
            </Link>
          </p>
        </div>
